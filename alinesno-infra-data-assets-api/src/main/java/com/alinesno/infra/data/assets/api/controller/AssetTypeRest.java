...
@RequestMapping("/api/infra/data/assets/type")
public class AssetTypeRest extends BaseController<AssetTypeEntity, IAssetTypeService> {

    //日志记录
    private static final Logger log = LoggerFactory.getLogger(AssetTypeRest.class);
    ...
    @Override
    public IAssetTypeService getFeign() {
