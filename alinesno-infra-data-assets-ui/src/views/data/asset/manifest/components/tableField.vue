<template>
    <div v-loading="loading" element-loading-text="Loading...">
        ...
        <el-scrollbar ref="scrollContainer" style="height:calc(100vh - 350px)"> 
        <div class="db-editor">
            <el-table :data="fields" style="width: 100%">
                <el-table-column prop="name" label="列名" width="280">
                    <template #default="scope">
                        ...
                        <div v-if="errors[scope.$index] && errors[scope.$index].name" class="error">{{errors[scope.$index].name }}</div>
                    </template>
                </el-table-column>
                <el-table-column prop="type" label="数据类型" width="180">
                    <template #default="scope">
                        ...
                        <div v-if="errors[scope.$index] && errors[scope.$index].type" class="error">{{errors[scope.$index].type }}</div>
                    </template>
                </el-table-column>
