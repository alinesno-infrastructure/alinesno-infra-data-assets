...
@RequestMapping("/api/infra/data/assets/collection")
public class AssetCollectionRest extends BaseController<AssetCollectionEntity, IAssetCollectionService> {
    ...
    @Override
    public IAssetCollectionService getFeign() {
        return this.assetCollectionService;
    }
}
